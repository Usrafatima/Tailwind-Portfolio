...
<div className="flex flex-col items-center">
  ...
  <div className="text-center">
    ...
    <p className="whitespace-normal max-w-lg lg:max-w-xl my-5 mx-auto">
      I'm committed to continual learning, and I'm currently expanding my skills in UI/UX design, working on a range of personal and professional projects. I aim to blend my technical expertise with a user-centered approach to design, ensuring every project is both aesthetically pleasing and functional.
    </p>
  </div>
